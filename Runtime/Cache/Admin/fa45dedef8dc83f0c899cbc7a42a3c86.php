      ...
      <tr>
        ...
        <td>
          <select name="parent_id">
                        <?php if(is_array($gettree)): foreach($gettree as $key=>$v): if($catinfo['parent_id'] == $v['cat_id']): ?><option value="<?php echo ($v["cat_id"]); ?>" selected><?php echo ($v["cat_name"]); ?></option>
                         <?php else: ?>
                         <option value="<?php echo ($v["cat_id"]); ?>"><?php echo ($v["cat_name"]); ?></option><?php endif; endforeach; endif; ?>
